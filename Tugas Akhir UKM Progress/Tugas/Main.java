...
public class Main {
    ...
    public void generateDaftarMenu(){
        ...
        daftarMenu.tambahMenu(new Kuah("Kuah Soto"));
        ...
        daftarMenu.tambahMenu(new Minuman("Jus Jeruk", 8000));
        daftarMenu.tambahMenu(new Minuman("Es Coklat", 14000));
        daftarMenu.tambahMenu(new Minuman("Capucino Coffee", 20000));
        daftarMenu.tambahMenu(new Minuman("Bir Bintang", 30000));
        daftarMenu.tambahMenu(new Minuman("Coca-Cola", 15000));
